...
export default function Hero() {
  return (
    <div className="flex justify-center items-center border border-yellow-700  bg-gradient-to-t from-white to-blue-200">
      <div className="w-[50%] py-[250px] flex flex-col p-10 item ml-10">
      ...
      <div className="w-[50%] relative flex justify-center">
        <Image src="/graph.png" width={500} height={500} />
      </div>
    </div>
  );
}
